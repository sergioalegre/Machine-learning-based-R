#Basado en : https://www.eduonix.com/dashboard/applied-machine-learning-for-professionals/lecture/16108516
# ---------------------------------------------
...
actuals <- read.csv('POS_Actuals.csv', header = T, stringsAsFactors = F)
str(actuals)
