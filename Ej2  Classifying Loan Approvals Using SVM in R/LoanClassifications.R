...
# Features de tipo numérico (numeric)
num_vars <- loan_data00 %>%
  select_if(is.numeric)
names(num_vars) #veremos que features son numéricas
...
#Aunque es un campo numérico vemos que la média 'Mean' es 342 que no existe en ningun registro asi que vamos a tratar este campo como tipo texto
...
#veremos que hay 13 registros sin el campo género (gender) y lo mismo con varios campos
